...
/**
 * @file
 * @brief Main header for mp_dump.
 */

#ifndef ZEPHYR_INCLUDE_MP_UTILS_MP_DUMP_H_
#define ZEPHYR_INCLUDE_MP_UTILS_MP_DUMP_H_

/**
 * @defgroup mp_dump Topology dump
 ...
 * has nothing left to do, and @ref mp_caps_filter does exactly that, relinking
 ...
 *
 * @param bin Bin to render. A pipeline is one, cast to @ref mp_bin.
 ...
 *
 * @param state State to name, see @ref mp_state.
...
#endif /* ZEPHYR_INCLUDE_MP_UTILS_MP_DUMP_H_ */
