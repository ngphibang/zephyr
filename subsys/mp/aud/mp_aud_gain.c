...
static int mp_aud_gain_set_property(struct mp_object *obj, uint32_t key, const void *val)
{
...
static int mp_aud_gain_get_property(struct mp_object *obj, uint32_t key, void *val)
{
	struct mp_aud_gain *self = (struct mp_aud_gain *)obj;
